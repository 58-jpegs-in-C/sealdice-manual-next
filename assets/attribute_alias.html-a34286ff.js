import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as l,c,a as e,d as n,b as t,e as a}from"./app-27d44939.js";const o={},r=a(`<h1 id="属性同义词" tabindex="-1"><a class="header-anchor" href="#属性同义词" aria-hidden="true">#</a> 属性同义词</h1><div class="hint-container info"><p class="hint-container-title">本节内容</p><p>本节将介绍海豹在 CoC 和 D&amp;D 规则中默认使用的同义词。</p></div><h2 id="概念说明" tabindex="-1"><a class="header-anchor" href="#概念说明" aria-hidden="true">#</a> 概念说明</h2><p>属性同义词是在录入和存储角色数据时，将若干个属性名视为同一个属性、互相可以替代使用。</p><p>这一设计是为了解决下面这样的问题：（由于笔者的游戏栈，使用 CoC 举例）</p><div class="hint-container note"><p class="hint-container-title">场景举例</p><p>用户可能使用某些自动工具创建了一名调查员，由工具生成了录入数据的指令。这指令可能包含了类似这样的内容：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.st 力量50str50
